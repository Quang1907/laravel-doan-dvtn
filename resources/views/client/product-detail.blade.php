            ...
            <div class="flex flex-col md:flex-row -mx-4">
                ...
                <div class="md:flex-1 px-4">
                    ...
                    <div class="flex py-4 space-x-4">
                        <div class=" flex">
                            <label
                                class="text-center pr-3  text-xs uppercase text-gray-400 tracking-wide flex items-center  font-semibold">
                                Quantity</label>
                            <input type="number" value="1" name=""
                                class="w-14 cursor-pointer appearance-none rounded-xl border border-gray-200 pl-4 flex items-end pb-1"
                                id="">
                        </div>
