...
@section('content')
    <form class="space-y-6 w-1/2 m-auto my-5" action="{{ route('account.checkLogin') }}" method="post">
        ...
        <div class="text-right">
            ...
            <a href="{{ url( 'auth/google' ) }}" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
        ...
        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
            Bạn chưa đăng ký? <a href="{{ route('account.create') }}"
