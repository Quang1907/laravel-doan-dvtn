<section>
   ...
   <!-- /navigation -->
        ...
        <div class="container">
            <div class="columns">
                <div class="column is-9-widescreen mx-auto">
                    <h1 class="mb-4 text-5xl font-bold uppercase">Checkout</h1>
                    <ul class="list-inline">
                        <li class="list-inline-item"><a class="text-default" href="{{ url('san-pham') }}">Shop
                                &nbsp; &nbsp; /</a></li>
                        <li class="list-inline-item text-primary">Checkout</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-3">
        <div class="lg:col-span-2 col-span-3 space-y-8 px-12 pb-4">
            <div class="mt-8 p-4 relative flex flex-col sm:flex-row sm:items-center border bg-white shadow rounded-md">
            ...
            <div class="rounded-md ">
                <form id="payment-form" method="POST" action="">
                    <section>
                        ...
                        <fieldset class="mb-3 bg-white shadow-xl border rounded-xl text-gray-600">
