    ...
    <div class="pt-12 lg:pt-16">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
                <div class="col-span-full lg:col-span-2">
                    ...
                    <div class="lg:-mt-2 mb-4">
                        <a href="/"
                            ...
                            <span class="self-center text-blue-700">{{ $websiteSetting->website_name ?? "Đoàn viên thanh niên" }}</span>
                        </a>
                    </div>
                    <!-- logo - end -->

                    <p class="text-gray-500 sm:pr-8 mb-6">{{ $websiteSetting->address ?? "Thừa Thiên Huế" }}</p>
                ...
                <!-- nav - start -->
                <div>
                    <div class="text-gray-800 font-bold tracking-widest uppercase mb-4">liên lạc với chúng tôi</div>
            ...
            <div class="text-gray-400 text-sm text-center border-t py-8">© 2021 - Present Flowrift. All rights
                reserved.</div>
        </div>
    </div>
</footer>
