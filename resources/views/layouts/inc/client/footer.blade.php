                ...
                <div class="col-span-full lg:col-span-2">
                    ...
                    <div class="lg:-mt-2 mb-4">
                        <a href="/"
                            ...
                            aria-label="logo">
                            <svg width="95" height="94" viewBox="0 0 95 94" class="w-5 h-auto text-indigo-500"
                    ...
                    <p class="text-gray-500 sm:pr-8 mb-6">Filler text is dummy text which has no meaning however looks
